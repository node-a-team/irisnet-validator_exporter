...
func SetMetric(currentBlock int64, restData *rest.RESTData, rpcData *rpc.RPCData, log *zap.Logger) {
	...
	metricData.Network.Staking.LooseTokens = utils.StringToFloat64(restData.StakingPool.Loose_tokens)
	metricData.Network.Staking.BondedTokens = utils.StringToFloat64(restData.StakingPool.Bonded_tokens)
	metricData.Network.Staking.TotalSupply = utils.StringToFloat64(restData.StakingPool.Total_supply)
	metricData.Network.Staking.BondedRatio = utils.StringToFloat64(restData.StakingPool.Bonded_ratio)
	...
	// commission
	metricData.Validator.Commission.Rate = utils.StringToFloat64(restData.Validators.Commission.Rate)
	metricData.Validator.Commission.MaxRate = utils.StringToFloat64(restData.Validators.Commission.Max_rate)
	metricData.Validator.Commission.MaxChangeRate = utils.StringToFloat64(restData.Validators.Commission.Max_change_rate)
